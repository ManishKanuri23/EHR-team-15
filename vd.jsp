    ...
    <tr>
        ...
        <td><%=rs.getString(4)%></td>
         <td><%=rs.getString(5)%></td>
          ...
          <td><a href="vd1.jsp?filename=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>&keyword=<%=rs.getString(3)%>&cipher=<%=rs.getString(4)%>&uemail=<%=rs.getString(5)%>&dtype=<%=rs.getString(6)%>">Verify</a> </td>

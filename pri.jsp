    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="pri.jsp">Private</a></li>
  ...
  <%
      // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM upload  where bckey2='pending'  ");
    ...
    <tr>
        ...
        <td><%=rs.getString(6)%></td>
         <td><%=rs.getString(7)%></td>
          <td><a href="pri1.jsp?filename=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>&keyword=<%=rs.getString(6)%>&hc=<%=rs.getString(7)%>">Generate</a> </td>

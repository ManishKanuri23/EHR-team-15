    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="pub.jsp">Public</a></li>
          <li><a class="nav-link scrollto" href="pri.jsp">Private</a></li>
          <li><a class="nav-link scrollto" href="cvf.jsp">View Files</a></li>
          <li><a class="nav-link scrollto" href="req.jsp">Requests</a></li>
  ...
  <%
      // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM upload  where bckey1='pending'  ");
    ...
    <tr>
        ...
        <td><%=rs.getString(6)%></td>
         <td><%=rs.getString(7)%></td>
          <td><a href="pub1.jsp?filename=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>&keyword=<%=rs.getString(6)%>&hc=<%=rs.getString(7)%>">Generate</a> </td>

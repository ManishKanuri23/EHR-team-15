...
<body>
  ...
  <%
      String filename=request.getParameter("filename");
        //    String password=request.getParameter("password");
            ...
            String str = "";
            String content = "";
            String remail=request.getParameter("uemail");
        Connection  co = databasecon.getconnection();
    Statement st = co.createStatement();
    ResultSet rs = st.executeQuery("select * from upload where filename= '"+filename+"'  and email='"+email+"' ");
    if(rs.next())
    {
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    ...
    <center><br>
                          ...
                          <h3 style="color:white">Verify</h3><br>
                                ...
                                <form style="width: 30%;margin-bottom: 40%" action="d4.jsp" method="post" >
  ...
  <!-- Password input -->
  <div class="form-outline mb-4">
      <input type="text" name="content" value="<%=content%>" id="form2Example2" placeholder="Enter Key" required="" class="form-control" />
  </div>
  <input type="hidden" name="email" value="<%=email%>" id="form2Example2" placeholder="" required="" class="form-control" />
  <input type="hidden" name="uemail" value="<%=remail%>" id="form2Example2" placeholder="" required="" class="form-control" />

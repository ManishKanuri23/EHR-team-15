...
<body>
  ...
  <div class="form-outline mb-4">
      <input type="text" name="keyword" id="form2Example1" placeholder="Keyword" required="" class="form-control" />
  </div>

   <div class="form-outline mb-4">
      <input type="time" name="utime" id="form2Example2" placeholder="time" required="" class="form-control" />
  </div>
  ...
  <div class="form-outline mb-4">
   ...
   <div class="form-outline mb-4">
      <input type="text" name="filename" id="form2Example1" placeholder="Filename" required="" class="form-control" />
  </div>
  
   <div class="form-outline mb-4">
      <input type="file" name="file" id="form2Example2" placeholder="Mobile" required="" class="form-control" />
  </div>
